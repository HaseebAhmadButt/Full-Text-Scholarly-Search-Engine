///*
//This file contains the Solr Client for the Singleton instance, which
//is used to communicate with the Solr server.
//That's why this file has been commented out but not deleted. So, that other users can see the
//proper functioning of the Singleton Solr client.
//Other Component Contains code for communicating with the Solr server in Cloud Mode.
//
// */
//
//
